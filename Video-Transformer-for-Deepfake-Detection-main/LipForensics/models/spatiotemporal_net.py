...
def get_model(weights_forgery_path=None, device="cuda:0"):
    ...
    """
    args_loaded = load_json(r'C:\Users\Robin\Desktop\Video-Transformer-for-Deepfake-Detection-main\Video-Transformer-for-Deepfake-Detection-main\LipForensics\models\configs\lrw_resnet18_mstcn.json')
