...
def get_model(weights_forgery_path=None, device="cuda:0"):
    ...
    """
    args_loaded = load_json(r'Video-Transformer-for-Deepfake-Detection-main\LipForensics_mix\models\configs\lrw_resnet18_mstcn.json')
